...
const AdminPage = ({ navigation }: any) => {
  return (
      ...
      >
        ...
        <View style={styles.content}>
          <Text style={styles.title}>
            <Text style={styles.highlight}>LettUce Admin{'\n'}</Text>
            <Text style={{ color: COLORS.text }}>Manage Your </Text>
            <Text style={{ color: COLORS.brown }}>Restaurant!</Text>
          </Text>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("AdminRegister")}>
            <Text style={styles.linkText}>
              Don’t have an admin account? <Text style={styles.link}>Register now</Text>
            </Text>
          </TouchableOpacity>
        </View>
      </ImageBackground>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 34, fontWeight: "700", color: COLORS.text, marginBottom: 30 },
